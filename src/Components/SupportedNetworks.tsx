...
const handleSlideChange=(direction:string)=>{
  if(direction==="forwards" ){
    ...
    const displaycards:any=[
        ...
        {id:2,url:coin ,title:'File Coin',desc:'Stake any amount of FIL, get monthly staking rewards and use your FIL across the web3 ecosystem.',perc:'10%-18%',price:'2,662,312,501',month:'APR'},
