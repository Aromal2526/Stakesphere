...
<p className="text-secondary">
  <span className="font-bold block ">Simplified and secure</span>
  participation<br/> in staking
</p>
</div>
...
<p className="text-secondary">
  <span className="font-bold block ">Liquidity <span className="font-normal">for</span></span> for 
  staked<br/> tokens
</p>
</div>
</div>
